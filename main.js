...
length_of_name_of_students_array=name_of_the_student_array.length;
...
console.log(display_student_array);
document.getElementById("display,,,").innerHTML=display_student_array;

var remove_commas = display_student_array.join("  ");

console.log(remove_commas);
document.getElementById("display-,,,").innerHTML=remove_commas;
